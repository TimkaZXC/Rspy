...
Moonlight = "By: Yesakout"
Moonlight.ResetOnSpawn = false

local SpyFind = CoreGui:FindFirstChild(Moonlight.Name)

if SpyFind and SpyFind ~= Moonlight then
  SpyFind:Destroy()
end

Background.Name = "Background"
Background.Parent = Moonlight 
...
Simple.Text = "Tebe Pizda Game"
Simple.TextColor3 = Color3.new(102, 45, 1)
Simple.TextSize = 14
